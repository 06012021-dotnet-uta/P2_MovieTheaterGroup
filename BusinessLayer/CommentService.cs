...
namespace BusinessLayer
{
    ...
    public class CommentService : ICommentService
    {
        ...
        public async void CreateCommentAsync(int userid, string movieid, string content)
        {
            var comment = _context.Comments.Where(x => (x.UserId == userid) && (x.MovieId == movieid)).FirstOrDefault();
